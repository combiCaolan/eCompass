...
file = String(sessionStorage.getItem('ServerPath') + '/ecompass/Settings-files/' + sessionStorage.getItem('APIV') + '/' + localStorage.getItem('Language') + '/DefaultAddParameters.txt');
var rawFile = new XMLHttpRequest();
...
file = String(sessionStorage.getItem('ServerPath') + '/ecompass/Settings-files/' + sessionStorage.getItem('APIV') + '/' + localStorage.getItem('Language') + '/LANGUAGE_' + localStorage.getItem('Language') + '.txt');
var rawFile = new XMLHttpRequest();
rawFile.open("GET", file, false);
rawFile.onreadystatechange = function ()
{
...
file = String(sessionStorage.getItem('ServerPath') + '/ecompass/Settings-files/' + CurrentDefaultApiVersion + '/' + localStorage.getItem('Language') + '/DropDown_list.txt');
var rawFile = new XMLHttpRequest();
rawFile.open("GET", file, false);
rawFile.onreadystatechange = function ()
{
...
UnitsDirectoryPath = String(sessionStorage.getItem('ServerPath') + '/ecompass/Settings-files/' + CurrentDefaultApiVersion + '/' + localStorage.getItem('Language') + '/UnitsDirectory.txt');
...
file = String(sessionStorage.getItem('ServerPath') + '/ecompass/Settings-files/' + CurrentDefaultApiVersion + '/' + localStorage.getItem('Language') + '/Parameter_999.txt');
var rawFile = new XMLHttpRequest();
rawFile.open("GET", file, false);
rawFile.onreadystatechange = function ()
{
...
file = String(sessionStorage.getItem('ServerPath') + '/ecompass/Settings-files/' + CurrentDefaultApiVersion + '/' + localStorage.getItem('Language') + '/Parameter_1000.txt');
var rawFile = new XMLHttpRequest();
rawFile.open("GET", file, false);
rawFile.onreadystatechange = function ()
{
...
file = String(sessionStorage.getItem('ServerPath') + '/ecompass/Settings-files/' + CurrentDefaultApiVersion + '/' + localStorage.getItem('Language') + '/Description_special.txt');
var rawFile = new XMLHttpRequest();
rawFile.open("GET", file, false);
rawFile.onreadystatechange = function ()
{
...
file = String(sessionStorage.getItem('ServerPath') + '/ecompass/Settings-files/' + sessionStorage.getItem('APIV') + '/' + localStorage.getItem('Language') + '/Parameter_Main.txt');
var rawFile = new XMLHttpRequest();
rawFile.open("GET", file, false);
rawFile.onreadystatechange = function ()
{
...
file = String(sessionStorage.getItem('ServerPath') + '/ecompass/Settings-files/' + sessionStorage.getItem('APIV') + '/' + localStorage.getItem('Language') + '/Description_Main.txt');
var rawFile = new XMLHttpRequest();
rawFile.open("GET", file, false);
rawFile.onreadystatechange = function ()
{
...
file = String(sessionStorage.getItem('ServerPath') + '/ecompass/Settings-files/' + sessionStorage.getItem('APIV') + '/' + localStorage.getItem('Language') + '/TemplateFile.clp');
var rawFile = new XMLHttpRequest();
rawFile.open("GET", file, false);
rawFile.onreadystatechange = function ()
{
