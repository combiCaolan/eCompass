...
//$sql = "INSERT INTO mocas_main ". "(timestamp,serial,model,username,user_email,access_level,module_id,module,timewindow_new,hourmeter_new,validation_code,comments) ". "VALUES(NOW(),'$serial','$model','$username','$useremail','$access_level','$module_id','$module','$timewindow_new','$hourmeter_new','$validation_code','$comments')";
...
<head>
	...
	<body>
		...
		<h1 id="Title">MoCAS - Hourmeter Update</h1>
		<div id="ActivationModule"/>
			<?php
 				echo ("Serial Number:" . $serial . "<br>");
				echo ("Module:" . $module . "<br>");
				echo ("New hourmeter value in sec:" . $hourmeter_new . "<br>");
				echo ("Hourmeter time window in sec:" . $timewindow_new . "<br>");
				...
				echo('<script> Hourmeter = ' . $hourmeter_new . '</script>');
				echo('<script> Hourmeter_mix = ' . $hourmeter_mix . '</script>');
		...
		<script>
			function ChangeModules(){
				...
				Hourmeter_str = Hourmeter.toString();
				Hourmeter_mix_str = Hourmeter_mix.toString();
