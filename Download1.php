...
<html>
	...
	<div id="row_usr">
		<div id="right_row">
			<img id="LogoHead" src="https://combilift.com/en/wp-content/uploads/sites/10/2017/09/Combilift-Master-logo-opt-300x82.png">
			<br/>
	...
	<script>
		...
		download('COMBI_PAR.clp', sessionStorage.getItem('Parameters').replace(/^\s*[\r\n]/gm, ''));
	</script>
	</body>
