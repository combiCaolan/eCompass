...
//$sql = "INSERT INTO mocas_main ". "(timestamp,serial,model,username,user_email,access_level,module_id,module,validation_code,comments) ". "VALUES(NOW(),'$serial','$model','$username','$useremail','$access_level','$module_id','$module','$validation_code','$comments')";
...
<head>
	...
	<body>
		...
		<h1 id="Title">Module Activation System</h1>
		<div id="ActivationModule"/>
			...
			<input type="submit" id="returnButton" value="Return to editor" onclick="ChangeModules()"/>
		<script>
